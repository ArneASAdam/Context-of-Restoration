...
y=0:14;
figure
boxplot(ben_nodist,y, 'Colors',[0.1333  0.5451  0.1333],'PlotStyle','compact','symbol', '');
...
hold on
plot(y, table2array(recr2(15,2:end)),'LineWidth',1,'Color',[0 0.5 0.5]); %juveniles
hold on
plot(y, table2array(recr3(15,2:end)),'LineWidth',1,'Color',[0 0 1]); %juveniles
